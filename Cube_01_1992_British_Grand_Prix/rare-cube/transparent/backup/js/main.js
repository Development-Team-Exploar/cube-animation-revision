...
const createScene = function () {
    ...
    babylonLoader = BABYLON.SceneLoader.Append("./assets/", "cube_rare_gold.glb", scene, function (meshes) {
        ...
        gl.customEmissiveColorSelector = function (element, subMesh, material, result) {
            if (element.name === "White edge") {
                result.set(1, 0.76, 0.35, 11);
            } else if (element.name === "bottom") {
                result.set(0.3, 0.19, 0, .05);
            }else if (element.name === "White edge glow") {
                result.set(1, 1, 1, 1);
            }
            else {
                result.set(0, 0, 0, 0);
        ...
        scene.meshes.forEach(element => {
            ...
            if (element.name == 'Green edge' || element.name == 'White edge') {
                if (element.name == 'White edge') {
                    ...
                    element.material._emissiveColor = new BABYLON.Color3(0.02, 0.02, 0);
