...
const createScene = function () {
    ...
    babylonLoader = BABYLON.SceneLoader.Append("./assets/", "cube_rare_with icons_02.glb", scene, function (meshes) {
        ...
        scene.meshes[0].position = new BABYLON.Vector3(0, -.03, 0);
        ...
        scene.meshes.forEach(element => {
            ...
            if (element.name == 'Green edge' || element.name == 'White edge') {
                if (element.name == 'White edge') {
                    ...
                    element.material._emissiveColor = new BABYLON.Color3(1, 0.76, 0.35);
                    element.material.albedoColor = new BABYLON.Color3(1, 0.76, 0.35);
            ...
            if (element.name == 'bottom') {
                element.material.albedoColor = new BABYLON.Color3(1, 0.76, 0.35);
                element.material.emissiveColor = new BABYLON.Color3(0.3, 0.19, 0);
                element.material.emissiveIntensity = 1.5
                element.material.roughness = 0
                element.environmentIntensity = 2
            }
            ...
            if (element.name == 'magnifying-glass' || element.name == 'play-button') {
                element.material.emissiveIntensity = .4
            ...
            if (element.name == 'image cube_primitive0' || element.name == 'image cube_primitive1' || element.name == 'image cube_primitive2' || element.name == 'image cube_primitive3' || element.name == 'image cube_primitive4' || element.name == 'image cube.001' || element.name == 'Cube_primitive0' || element.name == 'Cube_primitive1') {
        ...
        scene.materials.forEach(element => {
            ...
            if (element.name == 'Material.005' || element.name == 'Material.006' || element.name == 'Material.007' || element.name == 'Material.008') {
                ...
                element.emissiveColor = new BABYLON.Color3(0.2, 0.2, 0.2);
        ...
        scene.getMaterialByName("Material.005").environmentIntensity = 0;
            ...
            if (pickResult.hit) {
                ...
                if (selectedMesh != null) {
                    if (clickedMeshName === selectedMesh.clickable.name) {
                        selectedMesh.clickable.material.albedoColor = new BABYLON.Color3(1, 1, 1);
                        selectedMesh.clickable.material.emissiveColor = new BABYLON.Color3(0.33, 0.18, 0);
                        selectedMesh.clickable.material.emissiveIntensity = 4
                        animatedMesh = selectedMesh
                    }
                } else {
                    if (animatedMesh != null) {
                        animatedMesh.clickable.material.albedoColor = new BABYLON.Color3(1, 1, 1);
                        animatedMesh.clickable.material.emissiveColor = new BABYLON.Color3(1, 1, 1);
                        animatedMesh.clickable.material.emissiveIntensity = .4
                    }
                }
            } else {
                if (animatedMesh != null) {
